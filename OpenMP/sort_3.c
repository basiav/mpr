...
int main(int argc, char** argv)
{
    ...
    #pragma omp parallel private(seed)
    {
        ...
        #pragma omp barrier // Wait for the buckets allocation by the master thread
        ...
        // #pragma omp barrier // ?? unnecessary, deleted, left here as it was there by accident during measurements
